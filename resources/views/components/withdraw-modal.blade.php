            ...
            <div class="modal-body">
                ...
                @else
                    <div class="alert alert-warning">
                        <h5><i class="bi bi-exclamation-triangle"></i> Withdrawals Temporarily Unavailable</h5>
                        <p>The withdrawal portal is currently closed. Please check back later when withdrawals are enabled.</p>
                        <p class="mb-0"><strong>Status:</strong> <span class="badge bg-danger">CLOSED</span></p>
                    </div>
                @endif
            </div>
            @if(\App\Models\GlobalSetting::isWithdrawalEnabled())
...
<script>
// Simple JavaScript for the withdrawal modal
document.addEventListener('DOMContentLoaded', function() {
    // Only initialize if the form exists (withdrawals are enabled)
    ...
    if (withdrawForm) {
        ...
        if (paymentMethodSelect && bankDetails) {
