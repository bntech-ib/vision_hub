            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="accessKey" class="col-md-4 col-form-label text-md-end">{{ __('Access Key') }}</label>

                            <div class="col-md-6">
                                <input id="accessKey" type="text" class="form-control @error('accessKey') is-invalid @enderror" name="accessKey" value="{{ old('accessKey') }}" required autocomplete="accessKey" autofocus>
