...
class WelcomeBonusWalletTest extends TestCase
{
    use RefreshDatabase;

    /**
     * Test that new users receive a welcome bonus that is added to both their wallet balance and welcome bonus field.
     *
     * @return void
     */
    public function test_new_user_receives_welcome_bonus_in_wallet()
    {
        ...
        // Check that the user received the package welcome bonus in both fields
        $this->assertEquals($packageWelcomeBonus, $user->wallet_balance);
    ...
    /**
     * Test that new users with a package that has no welcome bonus receive zero in both fields.
     *
     * @return void
     */
    public function test_new_user_with_no_package_welcome_bonus_receives_zero()
    {
        ...
        // Check that the user received zero welcome bonus in both fields
